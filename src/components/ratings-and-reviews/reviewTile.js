            ...
            <div id='review-tile-container'>
                {(this.props.review) ? <> 
                    ...
                    <>{this.props.review.photos.map((photo) => {
                        return <img className='review-photo' key={photo.id} src={photo.url} value={photo.url} onClick={e => this.handleImgClick(e)}/>
                    })}</>
                    <Modal show={this.state.showImgModal} animation={false} onHide={e => this.handleImgClick(e)}>
